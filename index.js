...
هل هذا اسم شخص حقيقي؟ اقبل الأسماء التالية:
✅ أسماء عربية عادية: أحمد، محمد، علي، سارة، ريم، فاطمة، خالد
✅ أسماء مركبة: أحمد محمد، محمد علي، سارة أحمد
✅ أسماء مع ألقاب عائلية: أحمد العلي، محمد الأحمد، سارة مكاحلة، ريم الخطيب
✅ أسماء بدون مسافات: احمدعلي، محمدخالد

❌ ارفض فقط:
- أسماء وهمية أو كرتونية: سوبرمان، باتمان، النمر المقنع، الرجل الحديدي
- كلمات غير منطقية: اسدفغهج، ١٢٣٤، test
- أسماء حيوانات: الأسد، النمر (إلا إذا كانت مع اسم حقيقي)
